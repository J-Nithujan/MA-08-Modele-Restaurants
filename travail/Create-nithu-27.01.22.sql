USE [master]
GO
/****** Object:  Database [db_restaurants]    Script Date: 27.01.2022 14:58:44 ******/
...
( NAME = N'db_restaurants', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\db_restaurants.mdf' , SIZE = 73728KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'db_restaurants_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.MSSQLSERVER\MSSQL\DATA\db_restaurants_log.ldf' , SIZE = 73728KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
USE [db_restaurants]
GO
/****** Object:  Table [dbo].[allergens]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[dish_has_allergen]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[dish_has_ingredient]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[dishes]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[dishes_types]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ingredients]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[locations]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[measurement_units]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[order_detail_has_ingredient]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[order_details]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[orders]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[restaurant_has_dish]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[restaurant_has_sale]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[restaurant_has_sale](
	[id] [int] NOT NULL,
	[restaurant_id] [int] NULL,
	[sale_id] [int] NULL CHECK([sale_id]<50),
	[percentage] [int] NULL,
	[since] [datetime] NULL,
	[until] [datetime] NULL,
...
GO
/****** Object:  Table [dbo].[restaurant_has_user]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[restaurant_hast_type_of_restaurant]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[restaurant_types]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[restaurants]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[reviews]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[sales]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[users]    Script Date: 27.01.2022 14:58:45 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
CREATE TABLE [dbo].[users](
	...
	[birthdate] [date] NULL CHECK(year, DATEDIFF([birthdate], GETDATE()),
